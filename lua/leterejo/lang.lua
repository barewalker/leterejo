...
strings.en = {
  ...
  fetched = "Fetched",
  err_no_fetch_command = "No fetch command is configured for this account",
  err_fetch = "The fetch command failed",
  err_fetch_timeout = "The fetch command did not finish in %d seconds",
  count = "%d messages",
  readonly = "  [read-only]",
  empty = "  (no messages)",
  ...
  alternative_html = "Showing the rendered markup",
  alternative_plain = "Showing the text the sender's client wrote",
  alternative_only_one = "This message was sent once; there is no other half",
  ...
  bcc_not_self = "Bcc is not blind: `%s` goes out in the header every recipient receives. Only your own addresses may be put there (`bcc_policy`)",
  ...
  desc_raw_headers = "Show the whole header block, as it arrived",
  desc_raw_source = "Show the whole message, MIME and all",
  desc_help = "List the keys",
  desc_close = "Close",
  desc_back = "Back to list",
  desc_toggle_headers = "Toggle headers",
  desc_toggle_wrap = "Wrap long lines, or not",
  desc_toggle_alternative = "Show the other half: the rendering, or the plain text",
  desc_send = "Send",
...
strings.ja = {
  ...
  fetched = "取り込みました",
  err_no_fetch_command = "このアカウントの取り込みコマンドが設定されていません",
  err_fetch = "取り込みコマンドが失敗しました",
  err_fetch_timeout = "取り込みコマンドが %d 秒以内に終わりませんでした",
  count = "%d 件",
  readonly = "  [読み取り専用]",
  empty = "  (メールがありません)",
  no_subject = "(件名なし)",
  ...
  alternative_html = "HTML を描画したものを表示します",
  alternative_plain = "送信側が書いた素のテキストを表示します",
  alternative_only_one = "このメールは 1 通ぶんしかありません (別形式はありません)",
  ...
  to_empty = "宛先 (To) が空です",
  body_empty = "本文が空です",
  bcc_not_self = "Bcc は隠れません。`%s` は宛先全員に届くヘッダに入って出ていきます。ここに置けるのは自分のアドレスだけです (`bcc_policy`)",
  ...
  desc_sort = "並び順を変える",
  desc_raw_headers = "ヘッダ全体を届いたまま見る",
  desc_raw_source = "メール全体を届いたまま見る (MIME 込み)",
  desc_help = "キー一覧を出す",
  desc_close = "閉じる",
  desc_back = "一覧に戻る",
  desc_toggle_headers = "ヘッダーの表示を切り替える",
  desc_toggle_wrap = "長い行の折り返しを切り替える",
  desc_toggle_alternative = "HTML 描画と素のテキストを切り替える",
  desc_send = "送信する",
